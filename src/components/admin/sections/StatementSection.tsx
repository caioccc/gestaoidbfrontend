...
import { IconFileSpreadsheet, IconAlertTriangle, IconArrowUpRight, IconArrowDownRight } from '@tabler/icons-react';
...
export default function StatementSection({ api, churchLabel }: { api: AdminFinanceApi; churchLabel: string }) {
  ...
  return (
    <>
      <PageHeader title={t.statementPage.title} description={churchLabel}>
